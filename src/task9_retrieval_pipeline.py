...
def retrieve(
    ...
    """
    # 1. Chạy song song/nối tiếp semantic và lexical search
    ...
    # 3. Kiểm tra logic Fallback dựa trên Cosine score gốc của dense_results (Role 4 requirement)
